...
;===呼び出して値を登録するゾーン(一度通ればOK)======================
    *place
        [iscript ]
            ...
            if(f.maplst===undefined)f.etl='g2b';
            if(f.maplst==='f101_62_01_ent')f.etl='l2l';//玄関(第一工場)(E)から
            if(f.maplst==='f101_34_01_pic')f.etl='a2r';//ピッキング室(W))から
            ...
            //pushで範囲位置タイプを登録する
            push(1,1,13,2,2)//玄関(第一工場)(E)へ
            push(1,1,0,2,2)//ピッキング室(W)へ
