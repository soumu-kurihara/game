...
;===呼び出して値を登録するゾーン(一度通ればOK)======================
    *place
        [iscript ]
            ...
            if(f.maplst===undefined)f.etl='l2b';
            if(f.maplst==='f101_62_25_hwp')f.etl='o2l';//手洗い前室(E)から
            //if(f.maplst==='f201_01_01_mac')f.etl='a11r';//2F(W))から
            ...
            //pushで範囲位置タイプを登録する
            push(1,1,16,2,2)//手洗い前室(E2)へ
            push(2,3,1,1,1)//2F(W)へ(封鎖)
